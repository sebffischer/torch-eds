...
TODO:
* Explain a bit more how autograd works under the hood.
  we could e.g. illustrate how to implement a custom autograd function.
...
The simplest "neural network" is a linear model where we have slope $a$ and bias $b$ and a single input $x$.
...
2. Build a custom autograd function.
