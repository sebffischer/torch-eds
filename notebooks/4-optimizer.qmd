...
ggplot(d, aes(x = epoch, y = trainlogloss, color = lr)) +
  geom_line(aes(y = train.classif.logloss, color = "training logloss")) +
  geom_line(aes(y = valid.classif.logloss, color = "validation logloss")) +
  theme_minimal()
```
